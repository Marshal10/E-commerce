                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                <h2 class="nav-link" >Welcome <?php echo $_SESSION['username'];?></h2>
                              </li>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="text-bg">
                                 ...
                                 <h1>Accessories</h1>
                                 <p>Enhance your workspace and improve how you work, communicate and interact with computer accessories, laptop accessories and more — all from Insight.</p>
               ...
               <div class="col-md-12">
                  <div class="our_products">
                     <div class="row">
                        ...
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              <figure><img src="images/mob.png" height="78px" width="78px"alt="#"/></figure>
                              <h3>Mobile</h3>
                           </div>
                        </div>
                        <!-- <div class="col-md-4 margin_bottom1">
